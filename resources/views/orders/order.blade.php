...
@section('content')
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-primary btn-block" onclick="showOrderModal('{{ $product->id }}', '{{ $product->name }}', '{{ $product->price }}')">Order</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success btn-block" onclick="proceedToPayment()">Proceed to Payment</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Order Taken Modal -->
    <div class="modal fade" id="orderTakenModal" tabindex="-1" role="dialog" aria-labelledby="orderTakenModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
